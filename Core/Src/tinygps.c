...
volatile bool _is_gps_data_good;
...
// course in last full GNRMC sentence in 100th of a degree
inline unsigned long course() { return _course; }

// speed in last full GNRMC sentence in 100ths of a knot
...
#define COMBINE(sentence_type, term_number) (((unsigned)(sentence_type) << 4) | term_number)
